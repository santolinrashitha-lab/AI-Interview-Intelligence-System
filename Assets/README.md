...
Streamlit UI (app.py)
  │
  ▼
Question Generator (modules/question_generator.py)
  │
  ▼
User Response Input
  │
  ▼
Answer Evaluator (modules/answer_evaluator.py)
  │
  ▼
Scoring Engine (modules/scoring_engine.py)
  │
  ▼
Feedback + Score Output
  │
  ▼
Session Tracker (utils/tracker.py)
  │
  ▼
Interview History Storage (data layer)

## Flow Explanation

- User launches the Streamlit interface

- System generates domain-specific interview questions

- Candidate submits response

- NLP engine evaluates semantic quality

- Scoring engine calculates structured metrics

- Feedback is displayed

- Session metrics are tracked

- Interaction history stored for analytics
